...
<div style="text-align:right; margin-top:-20px; margin-bottom:30px">
  <a href="/estimates/KEN_combined_estimates.csv" download>📊 Download Full Estimates Data</a>
</div>
...
<!-- RH_DELP_C_PUT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/RH_DELP_C_PUT" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
...
<!-- RH_DELP_C_PRT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/RH_DELP_C_PRT" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
...
<!-- RH_DELP_C_HOT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/RH_DELP_C_HOT" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
      Delivery at home
    </div>
  </a>
...
<!-- RH_PCCT_C_DY2 !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/RH_PCCT_C_DY2" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
...
<!-- CH_DIAT_C_ORT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/CH_DIAT_C_ORT" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
      Diarrhea
    </div>
  </a>
...
<!-- CM_ECMR_C_NNF !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/CM_ECMR_C_NNF" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
