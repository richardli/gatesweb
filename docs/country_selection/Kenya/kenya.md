...
<div style="width: 55%; display:grid; grid-template-columns: repeat(2, 1fr); gap: 0px; text-align:center; font-weight:bold; margin-left: 210px">
  <div>Counties</div>
  <div>Sub-counties</div>
</div>

<div style="width: 55%; display:grid; grid-template-columns: repeat(4, 1fr); gap: 0px; text-align:center; font-weight:bold; margin-left: 210px">
  <div>2014</div>
  <div>2022</div>
  <div>2014</div>
  <div>2022</div>
...
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/CH_VACC_C_DP3" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      DTP3
    </div>
  </a>
...
<!-- CH_VACC_C_MSL !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/CH_VACC_C_MSL" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      MCV1
    </div>
  </a>
...
<!-- CH_VACC_C_NON !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/CH_VACC_C_NON" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      No Vaccine
    </div>
  </a>
...
<!-- CN_NUTS_C_HA2 !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/CN_NUTS_C_HA2" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Stunting
    </div>
  </a>
...
<!-- CN_NUTS_C_WH2 !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/CN_NUTS_C_WH2" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Wasting
    </div>
  </a>
...
<!-- ML_NETC_C_ITN !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/ML_NETC_C_ITN" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      ITN
    </div>
  </a>
...
<!-- CO_MOBB_W_MOB !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/CO_MOBB_W_MOB" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Mobile Phone
    </div>
  </a>
...
<!-- ED_EDUC_W_SEH !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/ED_EDUC_W_SEH" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Education
    </div>
  </a>
...
<!-- ED_LITR_W_LIT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/ED_LITR_W_LIT" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Literacy
    </div>
  </a>
...
<!-- FP_CUSM_W_MOD !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/FP_CUSM_W_MOD" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
...
<!-- HC_WIXQ_P_12Q !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/HC_WIXQ_P_12Q" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
     Lowest 2
    </div>
   <div>
...
<!-- RH_ANCN_W_N4P !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/RH_ANCN_W_N4P" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      ANC4 Visits
    </div>
  </a>
...
<!-- RH_DELA_C_SKP !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/RH_DELA_C_SKP" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Skilled Provider
    </div>
  </a>
...
<!-- RH_DELP_C_DHT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Kenya/RH_DELP_C_DHT" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Health Facility
    </div>
  </a>
