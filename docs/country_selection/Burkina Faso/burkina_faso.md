...
<div style="text-align:right; margin-top:-20px; margin-bottom:30px">
  <a href="/estimates/BFA_combined_estimates.csv" download>📊 Download Full Estimates Data</a>
</div>
...
<!-- RH_ANCN_W_N4P !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Burkina Faso/RH_ANCN_W_N4P" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
      4+ ANC Visits
    </div>
  </a>
...
<!-- RH_DELA_C_SKP !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Burkina Faso/RH_DELA_C_SKP" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
...
<!-- RH_DELP_C_DHT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Burkina Faso/RH_DELP_C_DHT" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
...
<!-- CH_VACC_C_MSL !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Burkina Faso/CH_VACC_C_MSL" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
      MCV 1 coverage
    </div>
  </a>
...
<!-- CO_MOBB_W_MOB !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Burkina Faso/CO_MOBB_W_MOB" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
...
<!-- ED_EDUC_W_SEH !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Burkina Faso/ED_EDUC_W_SEH" style="width:110px; font-weight:bold; font-size:12px;">
    <div>
