...
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/RH_ANCN_W_N4P" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      4+ ANC Visits
    </div>
  </a>
...
<!-- RH_DELA_C_SKP !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/RH_DELA_C_SKP" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
...
<!-- RH_DELP_C_DHT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/RH_DELP_C_DHT" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
...
<!-- CH_VACC_C_DP3 !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/CH_VACC_C_DP3" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      DTP3
    </div>
  </a>
...
<!-- CH_VACC_C_MSL !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/CH_VACC_C_MSL" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      MCV1
    </div>
  </a>
...
<!-- CH_VACC_C_NON !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/CH_VACC_C_NON" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      No Vaccine
    </div>
  </a>
...
<!-- CN_NUTS_C_HA2 !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/CN_NUTS_C_HA2" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Stunting
    </div>
  </a>
...
<!-- CN_NUTS_C_WH2 !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/CN_NUTS_C_WH2" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Wasting
    </div>
  </a>
...
<!-- ML_NETC_C_ITN !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/ML_NETC_C_ITN" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      ITN
    </div>
  </a>
...
<!-- CO_MOBB_W_MOB !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/CO_MOBB_W_MOB" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Mobile Phone
    </div>
  </a>
...
<!-- ED_EDUC_W_SEH !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/ED_EDUC_W_SEH" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Education
    </div>
  </a>
...
<!-- ED_LITR_W_LIT !-->
<div style="display:flex; align-items:center;">
  <a href="/country_selection/Senegal/ED_LITR_W_LIT" style="width:110px; font-weight:bold; font-size:16px;">
    <div>
      Literacy
    </div>
  </a>
